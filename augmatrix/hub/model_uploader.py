...
class AugmatrixUploader:
                            ...
                            while True:
                                ...
                                for line in lines:
                                    ...
                                    if len(parts) >= 3:
                                        ...
                                        elif filename == "epoch" and value not in epoch_set:
                                            labels.append(value)
                                            epoch_set.add(value)
                                if filename != "epoch": 
                                    dataset = {
                                ...
                                sending_data_json = {"label": list(labels), "dataset": datasets}
    ...
    def push_to_metrics(self):
        try:
            ...
            sending_binary_data = json.dumps(sending_data_json, ensure_ascii=False).encode('utf-8')
            ...
            data = {
                        ...
                        "model_metrices" : sending_binary_data,
    ...
    def push_to_hub(self):
        try:
            if os.path.isdir(self.file_path):
                ...
                with tqdm(total=total_file_size, desc="Uploading directory", unit="B") as pbar:
                    for root, _, files in os.walk(self.file_path):
                        for filename in files:
                            file_path = os.path.join(root, filename)
                ...
                print(f"Total uploaded size: {total_uploaded_size}/{total_file_size} bytes")
